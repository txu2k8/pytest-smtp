...
def pytest_addoption(parser):
    ...
    group.addoption('--email-to', help='Email receivers, comma-separated')
    ...
    parser.addini('email_to', help='Email receivers, comma-separated')
...
def pytest_terminal_summary(terminalreporter, config):
    ...
    if config.getoption("--send-email") is True:
        ...
        receivers = config.getoption('--email-to') or config.getini('email_to')
